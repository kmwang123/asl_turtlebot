...
<<<<<<< HEAD
	...
	#def subscriber():
	#    rospy.init_node('cmd_pose_subscriber',anonymous=True)
	rospy.Subscriber("/cmd_pose",Pose2D,self.cmd_pose_callback)
	 #   rospy.spin()


=======
        self.sub = rospy.Subscriber('/cmd_pose', Pose2D, self.cmd_pose_callback)
